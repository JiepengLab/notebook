...
而随机试验的所有可能结果构成的集合为**样本空间(sample space)**，记为$S$，其中的每一个元素为**样本点(sample point)**。

而样本空间的任一子集成为**随机事件(random event)**，简称事件。当且仅当事件中的一个样本点发生，称此事件发生。

- 特别的，只含有一个样本的子集称为**基本事件**。

---

**事件的相互关系**<br />![事件的相互关系](./1648003695351-a3590cf6-064e-4435-9dc6-07c15eee7c7a.png)
