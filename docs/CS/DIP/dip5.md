...
!!! note "Example"
    ![Alt text](images/image-185.png){width="50%"}

    ![Alt text](images/image-186.png){width="50%"}
...
!!! note "Example"
    ...
    ![Alt text](images/image-187.png){width="50%"}
...
!!! note "Example"
    ...
    ![Alt text](images/image-189.png){width="50%"}
