...
??? note "Todo"
    ...
    - [ ] ***(10.25)*** 数字逻辑设计: 实验报告四
    - [ ] ***(10.27 14:00)*** 工试2302经验分享
    - [ ] ***(10.28)*** 创业实践：从0到1: Spark创业点子秀，初期想法
    - [ ] ***(10.29)*** 数据结构基础: Project1 FINAL
    - [ ] ***(10.29)*** 工高学长交流会策划案终稿
    - [ ] ***(10.29)*** 数学建模: HW02
    - [ ] ***(10.29)*** 新中国史: [书评/读书报告](https://courses.zju.edu.cn/course/61083/learning-activity#/735663?view=scores)
    - [ ] ***(10.25-10.29)*** Python 100天: Day16-20
    - [ ] ***(10.30)*** 大学物理: P289 15-14 15-19 15-22 P352 19-1 19-2 19-9 19-10
    - [ ] ***(10.31)*** 数值分析: Read the proof of Theorem 7.7 on p.423；p.429-430 #5(a), 7, 13，p.436 #3
    - [ ] ***(11.01,23:59)*** 人工智能引论: 黑白棋(Mini AlphaGo)
    - [ ] ***(11.2)*** 概率论与数理统计: 习题三：A11,A12,A17,A19,A27,B4
    - [ ] ***(11.05)*** 数学建模: HW03
    - [ ] ***(11.05)*** 数据结构基础: PTA04
    - [ ] ***(11.05)*** 数据结构基础: PTA05
