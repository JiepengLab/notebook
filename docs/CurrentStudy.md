...
??? note "Todo"
    ...
    - [ ] ***(11.19)*** 数据结构基础: PTA07
    - [ ] ***(11.20)*** 大学物理(乙)II: P325  17-26 ;P339  18-2，18-3，18-4，18-5
    - [ ] ***(11.21,23:59)*** 人工智能引论: K-means 异常检测
    - [ ] ***(11.23)*** 概率论与数理统计：习题四: B24, B28, B29, B33, B34, 习题五:B4
    - [ ] ***(11.25)*** 工程导论：概念展示
    - [ ] ***(12.03)*** 数字逻辑设计：Lab07
    - [ ] ***(12.05)*** 马克思主义基本原理：读书报告
    - [ ] ***(12.07)*** 微信小程序综合实践：Lab04
    - [ ] ***(12.10)*** 军事理论：论文
    - [ ] ***(12.13)*** 马克思主义基本原理：展示
    - [ ] ***(12.31)*** ZJUFDS-2023-Sun-Bonus
    - [ ] ***(1.8,23:00)*** 概率论与数理统计：讨论题*5
