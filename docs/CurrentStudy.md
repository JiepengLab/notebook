...
??? note "Todo"
    ...
    - [ ] ***(12.05)*** 数值分析：HW: p.517 #3, 7, 9, p.506 #3, 11; p.176-177 #7, 13; p.195 #7, 9, 11, 1; 实验 Lab07
    - [ ] ***(12.06)*** 数字逻辑设计：Lab08提交
    - [ ] ***(12.06)*** 借教室
    - [ ] ***(12.07)*** 马原：小组讨论
    - [ ] ***(12.07)*** 概率论与数理统计：习题六: A3,A11,B2,B5,B7,B10
    - [ ] ***(12.08)*** 创业实践：从0到1: 小组讨论
    - [ ] ***(12.09)*** 创业实践：从0到1: 老师讨论
    - [ ] ***(12.10)*** 数学建模: 大作业讨论
    - [ ] ***(12.10)*** 数学建模: HW06
    - [ ] ***(12.10)*** 军事理论：论文
    - [ ] ***(12.10)*** 数据结构基础：HW09
    - [ ] ***(12.10)*** 大学物理(乙)II: P391  21-7,21-9，21-12; P405  22-2，22-3，22-5，22-7,22-10
    - [ ] ***(12.13)*** 马克思主义基本原理：展示
    - [ ] ***(12.14)*** 数字逻辑设计：Lab09提交
    - [ ] ***(12.17)*** 数学建模: HW07
    - [ ] ***(12.20)*** 数据结构基础：Project3
    - [ ] ***(12.21)*** 数字逻辑设计：Lab10提交
    - [ ] ***(12.23)*** 数据结构基础：Project3 PR
    - [ ] ***(12.27)*** 数据结构基础：Final
    - [ ] ***(12.28)*** 微信小程序综合实践：Lab06(代码已完成)
    - [ ] ***(12.30)*** 数学建模: 大作业展示
