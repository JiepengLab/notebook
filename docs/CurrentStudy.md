...
??? note "Todo"
    - [ ] ***(10.18)*** 数字逻辑设计: 实验报告三
    - [ ] ***(10.19)*** 概率论与数理统计: 习题二: B16, B17, B18, B19，B29
    - [ ] ***(10.19,23:59)*** 写好ML-4360 lec3,4笔记
    - [ ] ***(10.22,17:00)*** [竺可桢学院十佳荣誉学子] 填申请表
    - [ ] ***(10.22,23:59)*** 完成ML-4360 lec5,6
    - [ ] ***(10.22,23:59)*** 数据结构基础: Project1
    - [ ] ***(10.22,23:59)*** 微信小程序综合实践: Lab02
    - [ ] ***(10.23,23:59)*** 数据结构基础: PTA03
    - [ ] ***(10.23)*** 大学物理(乙)II: P285  15-3，15-4，15-5，15-8，15-9，15-10，15-11
    - [ ] ***(10.25,23:59)*** 数据结构基础: 互评Project1
