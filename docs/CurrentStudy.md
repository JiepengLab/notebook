...
??? note "Todo"
    ...
    - [ ] ***(11.23)*** 数值分析:  p.131 #5(a)(b); p.132 #13; p.140 #7,p.153-154 #9, 17; PTA Lab06
    - [ ] ***(11.23)*** 概率论与数理统计：习题四: B24, B28, B29, B33, B34, 习题五:B4
    - [ ] ***(11.25)*** 工程导论：概念展示
    - [ ] ***(11.26)*** 数字逻辑设计：Lab07
    - [ ] ***(11.27)*** 大学物理（乙）: 20-1，20-3，20-7，20-11，20-15，20-16
    - [ ] ***(12.05)*** 马克思主义基本原理：读书报告
    - [ ] ***(12.10)*** 军事理论：论文
    - [ ] ***(12.13)*** 马克思主义基本原理：展示
    - [ ] ***(12.14)*** 微信小程序综合实践：Lab05
    - [ ] ***(12.28)*** 微信小程序综合实践：Lab06
    - [ ] ***(1.4)*** 微信小程序综合实践：Lab07
